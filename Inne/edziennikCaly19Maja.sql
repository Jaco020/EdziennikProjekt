...
--
-- Host: 127.0.0.1
-- Czas generowania: 19 Maj 2021, 22:16
...
(4, 2, 2, '2021-05-15', '11:50-12:35', 'spóźnienie', '10 minut po', '');
...
(4, 2, 'KOMUNIKAT', 'E-dziennik jest już do pobrania w aplikacji Gdynia.pl. Od dziś łatwiej będzie zarówno o zachowanie kontaktu z placówką, zgłoszenie nieobecności, jak i sprawdzenie ocen. Wszystkie funkcje e-dziennika z Konta Mieszkańca mogą od teraz być dostępne na Państwa smartfonach.', '2020-10-06 14:03:13');
...
(3, 1, 2, 'KARTKOWKA', 'dzial 8', '', '2021-05-19'),
(4, 2, 1, 'Sprawdzian', 'Polska w XX wieku', 'Wagi 4', '2021-05-24');
